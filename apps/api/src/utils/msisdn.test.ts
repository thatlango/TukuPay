...
import { normalizeMsisdn, normalizeSandboxMsisdn, providerMsisdn } from './msisdn.js';
...
test('keeps MTN sandbox fixture numbers unscoped', () => {
  assert.equal(normalizeSandboxMsisdn('46733123453'), '46733123453');
});
